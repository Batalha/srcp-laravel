...
var ClienteService = /** @class */ (function () {
    ...
    ClienteService.prototype.save = function (data) {
        return !data.id ? this.http.post(this.url, data)
